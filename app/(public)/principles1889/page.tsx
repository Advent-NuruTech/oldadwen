    ...
    <main className="min-h-screen bg-gradient-to-b from-[#020617] via-[#0b1220] to-[#020617] text-white px-4 sm:px-6 py-12 sm:py-16">
      ...
      <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-16">
        ...
        <div className="mt-6 space-y-2">
          <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-cyan-300">of the</p>
          <p className="text-3xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-blue-300 via-cyan-200 to-indigo-300 bg-clip-text text-transparent">
            Fundamental Principles
          </p>
          <p className="text-xl sm:text-2xl md:text-3xl text-blue-200">Taught & Practiced</p>
          <p className="text-xl sm:text-2xl md:text-3xl text-blue-200">by</p>
          <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">The Seventh-Day Adventists</p>
          <p className="text-base sm:text-lg md:text-xl text-blue-300 mt-4">As Stated in the SDA Year Books</p>
          <p className="text-xl sm:text-2xl font-semibold text-cyan-300">of 1889-1931</p>
        </div>
        <div className="text-blue-400 text-xs sm:text-sm mt-6 space-y-1 sm:space-y-0 sm:space-x-2">
          <div>STEAM PRESS</div>
      ...
      <div className="max-w-4xl mx-auto mb-10 sm:mb-12 bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-cyan-300 text-center mb-4 sm:mb-6">FUNDAMENTAL PRINCIPLES</h2>
        <p className="text-blue-100 text-lg sm:text-xl md:text leading-relaxed">
        ...
        <p className="text-cyan-300 text-lg sm:text-xl mt-5 sm:mt-6 font-semibold text-center">They believe,</p>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        ...
        {/* PRINCIPLE 1 */}
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            ...
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            ...
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            ...
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">6</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">7</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">8</span>
            </div>
            <p className="text-blue-100 text-base sm:text-lg md:text-xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">9</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">10</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">11</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">12</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">13</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">14</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">15</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">16</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">17</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">18</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">19</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">20</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">21</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">22</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">23</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">24</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">25</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">26</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        <section className="bg-white/5 border border-blue-500/20 rounded-2xl p-5 sm:p-6 md:p-8 backdrop-blur-md transition-all hover:border-cyan-500/40">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">27</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
        ...
        {/* PRINCIPLE 28 */}
        <section className="bg-gradient-to-r from-blue-950/40 via-indigo-950/30 to-blue-950/40 border border-cyan-500/30 rounded-2xl p-5 sm:p-6 md:p-8">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/20 mx-auto sm:mx-0">
              <span className="text-white text-xl sm:text-2xl font-bold">28</span>
            </div>
            <p className="text-blue-100 text-lg sm:text-xl md:text-2xl leading-relaxed flex-1 text-center sm:text-left">
              That new heavens and a new earth shall spring by the power of God from the ashes of the old, and this renewed earth, with the New Jerusalem for its metropolis and capital, shall be the eternal inheritance of the saints, the place where the righteous shall evermore dwell. 2 Peter 3:13; Ps. 37:11, 29; Matt. 5:5.
            </p>
          </div>
        </section>
      </div>
      ...
      <div className="text-center pt-10 sm:pt-12 border-t border-blue-500/20 max-w-4xl mx-auto mt-8 sm:mt-8">
        <div className="bg-blue-950/30 border-l-4 border-cyan-400 p-5 sm:p-6 max-w-2xl mx-auto rounded-r-xl">
          <p className="text-cyan-200 italic text-2xl sm:text-2xl md:text-2xl">
            “Thus saith the Lord, Stand ye in the ways, and see, and ask for the old paths, where is the good way, and walk therein, and ye shall find rest for your souls.”
          </p>
          <p className="text-blue-200 font-semibold mt-2 text-base sm:text-lg">Jeremiah 6:16</p>
        </div>
        <p className="text-blue-400 text-xs sm:text-sm mt-6">STATEMENT OF BELIEFS 1889 — pp. 4-13</p>
      </div>
    </main>
  );
}